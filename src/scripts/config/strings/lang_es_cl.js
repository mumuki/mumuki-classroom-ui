angular
  ...
  .constant('LANG_ES_CL', {
    ...
    all: 'Todos',
    attach: 'Vincular',
    are_you_sure_attach_student_from_course: '¿Confirmas que quieres vincular al estudiante al curso?',
    are_you_sure_delete_student_from_course: '¿Confirmas que quieres borrar al estudiante del curso?',
    are_you_sure_detach_student_from_course: '¿Confirmas que quieres desvincular al estudiante del curso?',
    available_courses: 'Cursos disponibles',
    bulk: 'Masivo',
    by_last_submission_date: 'Por fecha de última solución',
    ...
    complete_form: 'Ingresa tus datos',
    confirm: 'Confirmar',
    copied: 'Copiado',
    ...
    exams: 'Exámenes',
    example: 'Ejemplo',
    exam_student_example_csv_link: 'Descarga un CSV de ejemplo haciendo click <a href="/assets/csv/exam/student-example.es.csv" download="ejemplo.csv" target="_blank">acá</a>',
    student_example_csv_link: 'Descarga un CSV de ejemplo haciendo click <a href="/assets/csv/student/student-example.es.csv" download="ejemplo.csv" target="_blank">acá</a>',
    teacher_example_csv_link: 'Descarga un CSV de ejemplo haciendo click <a href="/assets/csv/teacher/teacher-example.es.csv" download="ejemplo.csv" target="_blank">acá</a>',
    course_example_csv_link: 'Descarga un CSV de ejemplo haciendo click <a href="/assets/csv/course/course-example.es.csv" download="ejemplo.csv" target="_blank">acá</a>',
    example_csv_title: 'También puedes subir múltiples estudiantes cargando un archivo CSV',
    exercise: 'Ejercicio',
    ...
    export_course_report: 'Generar reporte general del curso',
    export_course_report_by_guide: 'Generar reporte del curso por guia',
    ...
    last_lesson: 'Última lección',
    last_name: 'Apellido',
    last_name_error: 'El campo apellido es obligatorio',
    last_solution: 'Última solución',
    less_than: 'Menor o igual a',
    lesson: 'Lección',
    log_in: 'Iniciar sesión',
    log_in_first: 'Tienes que iniciar sesión primero',
    log_out: 'Cerrar sesión',
    manual_evaluation: 'Corrección manual',
    ...
    members_count_to_process: "Cantidad de altas a procesar",
    ...
    new_course_days_error: 'Selecciona al menos un día',
    ...
    new_course_shift_error: 'Selecciona al menos un turno',
    new_exam: 'Nuevo examen',
    new_exam_warning: 'Esta guía está siendo usada actualmente por tu organización. Al crear un nuevo examen inhabilitará el acceso para su uso actual.<br><br>¿Realmente quieres crear el examen?',
    ...
    processed_count: 'Cantidad de altas procesadas correctamente',
    ...
    split: 'Separado',
    start_time: 'Desde',
    students_added_successfully_to_exam: 'Los estudiantes fueron agregados al examen con éxito',
    ...
    teachers: 'Docentes',
    term_and_conditions: 'Al registrarte estás aceptando las <a target="_blank" href="{{url}}"> condiciones de uso.</a>',
    tests: 'Pruebas',
